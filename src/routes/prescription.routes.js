...
router.get('/', authenticate, authorize(['admin', 'doctor', 'nurse']), prescriptionController.getAll);
...
router.get('/diagnosis/:diagnosisId', authenticate, prescriptionController.getByDiagnosisId);
